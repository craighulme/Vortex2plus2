...
import { viewZToOrthographicDepth, reference, uniform, float, vec4, vec2, If, Fn, min, renderGroup, positionView, shadow } from './three.tsl.js';
...
class CSMShadowNode extends ShadowBaseNode {
	...
	constructor( light, data = {} ) {
		 ...
		 * @default false
		 */
		this.fade = data.fade !== undefined ? data.fade : false;
